...
That works better than without marginalization. It would probably be even better if we blocked each pair of hyperparameters. You can try to do the blocking during the breakout exercise time.
